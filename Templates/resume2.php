                        ...
                        <div class="cv-form-blk">
                            ...
                            <div class="cols-3">
                                ...
                                <div class="form-elem">
                                    ...
                                    <input name="firstname" type="text" class="form-control firstname" id="demo"
                                    ...
                                    <div class="cols-2">
                                        <div class="form-elem">
                                            ...
                                            <input name="achieve_title" type="text" class="form-control achieve_title"
                                                id="" onkeyup="generateCV()" placeholder="e.g. johndoe@gmail.com">
                                            <span class="form-text"></span>
                                        </div>
                                        <div class="form-elem">
                            ...
                            <div class="preview-cnt-l bg-green text-white">
                                ...
                                <div class="preview-blk">
                                    ...
                                    <div class="preview-blk-list">
                                        ...
                                        <div class="preview-item">
                                            <span class="preview-item-val" id="summary_dsp"> Web developer with 2 years
                                                of
                                                hands-on experience in designing, developing, and optimizing websites
                                                and
                                                web applications. Possess a deep understanding of web technologies,
                                                coding
                                                languages, and industry standards, enabling them to create user-friendly
                                                and
